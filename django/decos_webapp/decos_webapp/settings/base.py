"""
Django settings for decos_webapp project.
...
ROOT_URLCONF = "decos_webapp.urls"
...
class CustomFormRenderer(TemplatesSetting):
    form_template_name= "decos_webapp/forms/div.html"
    field_template_name = "decos_webapp/forms/field.html"
...
WSGI_APPLICATION = "decos_webapp.wsgi.application"
# DATABASE ROUTING: extremely important to manage two (or more) database, check db_routers.py
DATABASE_ROUTERS = ["decos_webapp.db_routers.ExternalDbRouter"]
