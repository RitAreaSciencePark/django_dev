...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Administration',
            fields=[
                ('sr_id', models.CharField(default=uuid.UUID('daad5843-88ad-4cf0-9b6b-c47d37017139'), max_length=37, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='lageSample',
            fields=[
                ('sr_id', models.CharField(default=uuid.UUID('754c6dfa-b310-43c1-8ea5-6b8fd46ec0ed'), max_length=37, primary_key=True, serialize=False)),
                ('user_id', models.CharField(max_length=50)),
                ...
                ('samplesheet_file', models.FileField(blank=True, upload_to=PRP_CDM_app.models.lageSample.user_directory_path)),
                ('additional_files', models.FileField(blank=True, upload_to=PRP_CDM_app.models.lageSample.user_directory_path)),
                ('instrument', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='PRP_CDM_app.instruments')),
            ],
            options={
                'db_table': 'lagesample',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('DNA', 'DNA'), ('RNA', 'RNA'), ('pellet', 'pellet'), ('biopsy', 'biopsy')])),
